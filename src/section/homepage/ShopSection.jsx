...
export default function ShopSection() {
  return (
    <div className="shop-section mx-auto mb-8 grid h-[80vh] grid-cols-16 grid-rows-9 overflow-hidden sm:mb-0 md:mb-16 md:h-[100vh] lg:mb-32 xl:mb-0 xl:container xl:px-5 2xl:px-20">
      ...
      <p className="text-secondary z-1 col-start-9 col-end-16 row-start-2 py-10 font-serif leading-relaxed lg:text-2xl xl:col-start-10 xl:col-end-14">
        TIMELESS & SOPHISTICATED HANDBAG RENDERED IN FINE LEATHER.
      </p>

      {/* Right Images */}
      <div className="col-start-1 col-end-8 row-start-6 sm:row-start-6 md:pt-12 xl:col-start-7 xl:col-end-10 xl:row-start-5">
        <img
