  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 flex flex-col md:flex-row gap-8">
      ...
      <div className="flex-1 flex flex-col justify-start gap-6">
        ...
        <button className="bg-gray-900 text-white py-3 px-6 w-40 hover:bg-gray-800 transition">
          ADD TO BAG
        </button>
        ...
        <div className="flex flex-col gap-6 text-gray-700">
          ...
          <div>
            ...
            <p className="text-sm">
              {product.material ||
                (product.variants?.[0]?.material ?? "Material information not available.")}
            </p>
          </div>
          <div>
            ...
            <p className="text-sm">
              {product.length && product.width && product.height
                ...
                : product.variants?.[0]?.length && product.variants?.[0]?.width && product.variants?.[0]?.height
